...
const Home = ({ navigation }) => {
    ...
    // Función para navegar a la pantalla 'Collection'
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.title}>Mira los productos disponibles</Text>
            ...
            {/* Muestra la lista de productos si hay elementos, de lo contrario muestra un mensaje */}
            {
                ...
                />
                : 
                <Text style={styles.Subtitle}>ooh! No hay productos disponibles</Text>
            }
            ...
            {/* Botón para navegar a la pantalla de colección */}
            <TouchableOpacity
                style={[styles.Button, { backgroundColor: '#FF6B6B' }]} // Estilo modificado para el botón de colección
